...
public class Location {
	...
	public Location(String reference, int start, int end, String strand) {
	...
	public Location relativeTo(Location referenceLocus) {
		if(this.getReference() == null){
			//Relative to the begining of the sequence
			return new Location(referenceLocus.getReference(),
