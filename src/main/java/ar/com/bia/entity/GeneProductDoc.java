...
public class GeneProductDoc extends Sequence implements SeqFeature, Scoreable {
    ...
    private TrancriptionalRegulationData tregulation;
    ...
    public TrancriptionalRegulationData getTregulation() {
        return tregulation;
    }

    public void setTregulation(TrancriptionalRegulationData tregulation) {
        this.tregulation = tregulation;
    }
