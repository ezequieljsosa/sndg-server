    ...
    <c:choose>
        ...
        <c:otherwise>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header"
                            ...
                            <a href="${baseURL}/user/main"><img height="200px"
                                                                src="${baseURL}/public/html/Logo PathogenTARGET.jpg"/></a>
                        </div>
                        <div class="modal-body">
                            <form:form id="loginForm" action="login" class="form col-md-12 center-block"
                                       method="POST">
            ...
            <script type="text/javascript">
                ...
                if ("user" in $.QueryString) {
                    $("#username").val($.QueryString["user"])
                    $("#password").val($.QueryString["sessiontoken"])
                    $('#loginForm').submit()
                }
