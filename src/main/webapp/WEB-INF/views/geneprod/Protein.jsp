        ...
        function load_pathways(protein) {
            ...
            if (protein.tregulation) {
                if (protein.tregulation.tf_type) {
                    ...
                    $("#stringdb_id1").append($("<a/>",
                        {href: "https://string-db.org/network/" +
                            protein.tregulation.string}).html(protein.tregulation.string))
                    ...
                    protein.tregulation.regulates.forEach(x => {
                        ...
                        $("<td/>").appendTo(tr).append($("<a/>",
                            {href: "${baseURL}/protein/gene/" + x.locus_tag + "/"}).html(x.locus_tag));
                        $("<td/>").appendTo(tr).html(x.desc);
                        $("<td/>").appendTo(tr).html(x.with_transcript);
                        $("<td/>").appendTo(tr).html(x.is_tf);

                        $("<td/>").appendTo(tr).append($("<a/>",
                            {href: "https://string-db.org/network/" + x.string}).html(x.string));
                        $("<td/>").appendTo(tr).html(x.score);
                ...
                if (protein.tregulation.regulated_by) {

                    $("#stringdb_id2").append($("<a/>",
                        {href: "https://string-db.org/network/" +
                            protein.tregulation.string}).html(protein.tregulation.string))
    ...
    <div class="row">
        <section id="tregulates-section" class="col-lg-12 connectedSortable">
            <div class="box box-primary">
                ...
                <div class="box-body no-padding">
                    TF type: <b id="tf_type"> - </b> | StringDB ID: <b id="stringdb_id1"> - </b> <br/>
                    <table id="tregulates-table2" class="table table-stripped">
                        <thead>
                        <tr>
                            <td>Contig</td>
                            <td>Locus Tag</td>
                            ...
                            <td>Is TF</td>
                            <td>StringDB ID</td>
                            <td>StringDB Score</td>
                        </tr>
                        </thead>
                        <tbody id="tregulates-table"></tbody>
                    </table>
                </div>
        ...
        <section id="tregulated-section" class="col-lg-12 connectedSortable">
            <div class="box box-primary">
                ...
                <div class="box-body no-padding">
                    StringDB ID: <b id="stringdb_id2"> - </b> <br/>
                    <table id="tregulated-table2" class="table table-stripped">
                        <thead>
                        <tr>
                            <td>Contig</td>
                            <td>Locus Tag</td>
                        ...
                        <tbody id="tregulated-table"></tbody>
                    </table>
                </div>
