<jsp:root xmlns:jsp="http://java.sun.com/JSP/Page"
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td colspan="2"><a class="btn" id="download_button"
                                                   title="Download a zip file with the structure pdb and pockets">Download</a>
                                </td>
                            </tr>
                            </tbody>
                        </table>
    ...
    <div id="screen_row" class="row">
		...
		<span style="display:none" id="alnAdvice"> 
			<h1>
									...
									We are showing the aligned structure of the identified gene. To see the whole PDB  <a
                    href="${baseURL}/structure/${pdbName}">click here</a>.
									</h1>
								</span>
    ...
    <script type="text/javascript">
        ...
        var init2 = function () {
            ...
            builder._data_loaded_fn = function (glmol) {
                ...
                $.each(pockets, function (i, pocket_layer) {
                    ...
                    const pocket_data = $.grep(structure.pockets, function (x) {
                        return parseInt(x.name.split("_")[1]) == pocket_layer.name
                    });
        ...
        var init = function () {
            ...
            if ((stemplate == null) && ($.proteins.length > 0)) {

                const chain = $.proteins[0].features.filter(x => x.identifier.startsWith(structure.name))[0
                    ].identifier.split("_")[1];
                render_chain_tracks(structure, $.proteins, chain);
            }
            ...
            $("#btn_intersect").click(function (evt) {
                ...
                if ($.grep($.glmol.layers, function (layer) {
