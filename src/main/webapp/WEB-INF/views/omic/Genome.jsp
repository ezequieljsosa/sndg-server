<jsp:root xmlns:jsp="http://java.sun.com/JSP/Page"
    ...
    <head>
        ...
        <style type="text/css">
            .loading-img2 {
                z-index: 1020;
                background: transparent url('${baseURL}/public/theme/img/ajax-loader1.gif') 50% 50% no-repeat;
            }
    ...
    <script type="text/javascript">
        ...
        var load_genome = function (genome) {
            ...
            if (genome.kegg && (genome.kegg.length > 0)) {
            ...
            if ((genome.strains != null) && (genome.strains.length > 0)) {
                        ...
                        <div class="box">
                            <div class="box-body no-padding">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                    <tr>
                                        <td><a id="keyword_search" href="#"> <spring:message
                                                code="genome.keyword_search"/> </a>
                                    ...
                                    <tr>
                                        ...
                                        <td><a id="gene_search" href="#"> <spring:message code="genome.gene_search"/>
                                        </a>
                                            <div class="input-group">
                    ...
                    <div id="properties_table_box" class="box">
                        ...
                        <div class="box-body">
                            ...
                            <button id="upload_save_btn"
                                    class="iflogged btn btn-success btn-lg">Save
                            </button>
                        </div>
                    </div>
                        ...
                        <div class="modal-content">
                                    ...
                                    <div class="form-group">
                                        <p>
                                            ...
                                            click on the links: <a id="linkExDownload1"
                                                                   href="${baseURL}/public/docs/data_example.tsv">Example
                                            1</a>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" id="btn_upload_csv"
                                        class="iflogged btn btn-primary">Upload file
                                </button>
                            </div>
                        </div>
                    </div>
