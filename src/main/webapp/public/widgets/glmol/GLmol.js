...
GLmol.prototype.enableMouse = function() {
   ...
   $('#body').bind('mouseup touchend', function(ev) {
	     ...
	     /*
	      ...
	      vector.set(
	          (x / me.container.width() ) * 2 - 1,
	          - ( y /me.container.height() ) * 2 + 1,
	          0.5 );
	     ...
	     matrix = matrix.multiply( me.camera.matrixWorld, matrix.getInverse( me.camera.projectionMatrix ) );
		 ...
		 applyProjection(vector,matrix)
	      ...
	      var pos = me.camera.position.clone().add(me.camera.position.clone(), dir.multiplyScalar( distance ) );
	      tx = pos.x
	      ty = pos.y
